              ...
              {plans.map((plan, index) => (
                <div
                  ...
                  className={`relative rounded-2xl p-8 ${
                    plan.popular ? "bg-gray-900 text-white shadow-2xl scale-105" : "bg-white border-2 border-gray-200"
                  }`}
                >
                  {plan.popular && (
                  ...
                  <div className="mb-8">
                    <div className="flex items-baseline">
                      ...
                      {plan.price !== "Custom" && (
                        <span className={`ml-2 ${plan.popular ? "text-gray-300" : "text-gray-600"}`}>/month</span>
                      )}
                    </div>
                  </div>
                      ...
                      <li key={featureIndex} className="flex items-start">
                        <Check
                          className={`h-5 w-5 mr-3 mt-0.5 flex-shrink-0 ${
                            plan.popular ? "text-[#1aa478]" : "text-[#1aa478]"
                          }`}
                        />
                        <span
