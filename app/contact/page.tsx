        ...
        <section className="bg-gray-50 py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              {[
                {
                  q: "How quickly can I get started with Everpay?",
                  a: "You can start accepting payments within minutes of signing up. Our onboarding process is designed to be quick and efficient.",
                },
                {
                  q: "What payment methods do you support?",
                  a: "We support all major credit cards, digital wallets, and local payment methods across 150+ countries.",
                },
                {
                  q: "How secure are your payment solutions?",
                  a: "We maintain the highest level of security with PCI DSS Level 1 compliance and advanced fraud prevention systems.",
                },
              ].map((faq, index) => (
