...
import { isRequired, isEmail, isUrl } from "@/lib/simple-validation"
...
export function SimpleMerchantForm() {
  ...
  const validateForm = () => {
    const newErrors = {
      businessName: !isRequired(formData.businessName) ? "Business name is required" : "",
      email: !isRequired(formData.email)
        ? "Email is required"
        : !isEmail(formData.email)
          ? "Please enter a valid email"
          : "",
      website: formData.website && !isUrl(formData.website) ? "Please enter a valid URL" : "",
    }
