      ...
      <div className="container mx-auto px-4">
        <div className="mb-8 grid gap-16 md:grid-cols-2">
          <div className="space-y-6">
            <div className="text-sm font-medium text-blue-600 tracking-wide">DIGITAL EXCHANGE</div>
            <h2 className="text-4xl font-bold text-gray-900 leading-tight">Linking Commerce Via Transactions</h2>
