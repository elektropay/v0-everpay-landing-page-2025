      ...
      <div className="container mx-auto px-4">
        ...
        <ul className="flex overflow-x-auto pb-4 scrollbar-hide">
          ...
          <li className="flex min-w-[220px] items-center gap-3 rounded-xl bg-gray-100 p-4">
            ...
            <div>
              <h3 className="text-sm font-medium">Fast Payments</h3>
            </div>
          </li>
          ...
          <li className="flex min-w-[220px] items-center gap-3 rounded-xl bg-gray-100 p-4">
            ...
            <div>
              <h3 className="text-sm font-medium">Secure Transactions</h3>
            </div>
          </li>
          ...
          <li className="flex min-w-[220px] items-center gap-3 rounded-xl bg-gray-100 p-4">
            ...
            <div>
              <h3 className="text-sm font-medium">Global Support</h3>
            </div>
          </li>
        </ul>
